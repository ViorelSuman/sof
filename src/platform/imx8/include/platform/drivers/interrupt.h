...
#define IRQ_NUM_IRQSTR_LCL0	27	/* Level 2 */
#define IRQ_NUM_IRQSTR_LCL1	28	/* Level 2 */
...
#define IRQ_MASK_IRQSTR_LCL0	BIT(IRQ_NUM_IRQSTR_LCL0)
#define IRQ_MASK_IRQSTR_LCL1	BIT(IRQ_NUM_IRQSTR_LCL1)
